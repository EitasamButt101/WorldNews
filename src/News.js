...
export class News extends Component {
    ...
    constructor(){
      ...
      async componentDidMount(){
        console.log("cdm")
        let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=8a216d57d34b433da5b07e4783562b84&page=1"
...
let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=8a216d57d34b433da5b07e4783562b84&page ${this.state.page -1}`
        let data = await fetch(url)
        let parsedData = await data.json()
        console.log(parsedData)
        this.setState=({
